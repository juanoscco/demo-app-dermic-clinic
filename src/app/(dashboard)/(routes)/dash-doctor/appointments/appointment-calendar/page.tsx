...
export default function AppointmentCalendar() {
    ...
    const filteredEmployee = dataEmployee?.data?.content.filter((item: any) => item.sede.id_sede === parseInt(selectedSedeId) && item.titulo.id_cabecera_detalle === selectedProfessionId && item.id_empleado === initialDecodedState?.id_empleado);
