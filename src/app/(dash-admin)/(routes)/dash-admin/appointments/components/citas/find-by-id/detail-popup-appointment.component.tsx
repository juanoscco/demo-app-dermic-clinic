...
import { useGetAppointmentByIdQuery } from './store/service';
import { useUpdateAppointmentScheduleMutation } from '../update-schedule-appointment/store/services';
import { useUpdateInfoAppointmentMutation } from '../update-info-appointment/store/services';
