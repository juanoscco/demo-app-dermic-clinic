...
import { employeeDeleteReducer } from "@/app/(dash-admin)/(routes)/dash-admin/persons/list/[id]/components/employee-component/components/employee-delete/store/reducer";
import { employeeUpdateReducer } from "@/app/(dash-admin)/(routes)/dash-admin/persons/list/[id]/components/employee-component/components/employee-update/store/reducer";
